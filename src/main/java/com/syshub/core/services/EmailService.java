...
public class EmailService {
    ...
    public void sendPasswordResetEmail(String to, String token) {
        try {
            ...
            String htmlContent = buildHtmlTemplate(url);
    ...
    private String buildHtmlTemplate(String url) {
        return "<div style=\"font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8fafc; padding: 40px; color: #1e293b;\">" +
                ...
                "            <h2 style=\"margin-top: 0; color: #0f172a; font-size: 20px;\">Restablecer tu contraseña</h2>" +
                "            <p style=\"line-height: 1.6; color: #64748b;\">Recibimos una solicitud para restablecer la contraseña de tu cuenta académica en Syshub.</p>" +
                ...
                "            </div>" +
                "            <p style=\"font-size: 14px; color: #94a3b8; line-height: 1.6;\">Este enlace es válido por los próximos <strong>15 minutos</strong>. Si no solicitaste este cambio, puedes ignorar este correo de forma segura.</p>" +
